...
var Bitcore_ = {
  ...
  darkpay: require('darkpay-bitcore-lib'),
};
...
var BASE_URL = 'https://bws.darkpay.market/bws/api';
...
API.prototype.getFeeLevels = function(coin, network, cb) {
  ...
  $.checkArgument(coin || _.includes(['btc', 'bch', 'darkpay'], coin));
...
API.prototype.createWallet = function(walletName, copayerName, m, n, opts, cb) {
  ...
  var coin = opts.coin || 'btc';
  if (!_.includes(['btc', 'bch', 'darkpay'], coin)) return cb(new Error('Invalid coin'));
...
API.prototype.getBalance = function(opts, cb) {
  ...
  if (opts.coin) {
    if (!_.includes(['btc', 'bch', 'darkpay'], opts.coin)) return cb(new Error('Invalid coin'));
